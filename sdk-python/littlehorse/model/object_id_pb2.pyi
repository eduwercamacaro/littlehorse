...
class TaskDefMetricsId(_message.Message):
    ...
    task_def_id: TaskDefId
    def __init__(self, window_start: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., window_type: _Optional[_Union[_common_enums_pb2.MetricsWindowLength, str]] = ..., task_def_id: _Optional[_Union[TaskDefId, _Mapping]] = ...) -> None: ...
...
class WfSpecMetricsId(_message.Message):
    ...
    window_type: _common_enums_pb2.MetricsWindowLength
    wf_spec_id: WfSpecId
    def __init__(self, window_start: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., window_type: _Optional[_Union[_common_enums_pb2.MetricsWindowLength, str]] = ..., wf_spec_id: _Optional[_Union[WfSpecId, _Mapping]] = ...) -> None: ...
...
class BulkJobId(_message.Message):
    __slots__ = ("id",)
    ID_FIELD_NUMBER: _ClassVar[int]
    id: str
    def __init__(self, id: _Optional[str] = ...) -> None: ...
...
class QuotaId(_message.Message):
    ...
    def __init__(self, tenant: _Optional[_Union[TenantId, _Mapping]] = ..., principal: _Optional[_Union[PrincipalId, _Mapping]] = ...) -> None: ...

class MetricWindowId(_message.Message):
    __slots__ = ("wf_spec_id", "task_def_id", "user_task_def_id", "quota_id", "tenant_id", "window_start", "metric_type")
    WF_SPEC_ID_FIELD_NUMBER: _ClassVar[int]
    TASK_DEF_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, wf_spec_id: _Optional[_Union[WfSpecId, _Mapping]] = ..., task_def_id: _Optional[_Union[TaskDefId, _Mapping]] = ..., user_task_def_id: _Optional[_Union[UserTaskDefId, _Mapping]] = ..., quota_id: _Optional[_Union[QuotaId, _Mapping]] = ..., tenant_id: _Optional[_Union[TenantId, _Mapping]] = ..., window_start: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., metric_type: _Optional[_Union[_common_enums_pb2.MetricWindowType, str]] = ...) -> None: ...
